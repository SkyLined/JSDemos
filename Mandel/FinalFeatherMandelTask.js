function FinalFeatherMandelTask(oMandelRenderer) {
  var oThis = this;
  oThis.sDescription = 'Final angle, feathered for escape';
...
FinalFeatherMandelTask.prototype.run = function () {
  var oThis = this;
...
FinalFeatherMandelTask.prototype.setPixel = function() {
  var oThis = this,
      iIterations = 0,
      nCI = oThis.nY,
  ...
  var nValue1 = Math.pow((nAngle / Math.PI / 2) + .5, oThis.oMandelRenderer.nColorPower);
  ...
  var nValue2 = Math.pow((nAngle / Math.PI / 2) + .5, oThis.oMandelRenderer.nColorPower);
