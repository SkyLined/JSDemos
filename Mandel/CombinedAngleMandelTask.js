function CombinedAngleMandelTask(oMandelRenderer) {
  var oThis = this;
  oThis.sDescription = 'Combined angles';
...
CombinedAngleMandelTask.prototype.run = function () {
  var oThis = this;
  oThis.setPixel();
  oThis.iX++;
...
CombinedAngleMandelTask.prototype.setPixel = function() {
  var oThis = this,
      iIterations = 0,
      nCI = oThis.nY,
