function BasicMandelTask(oMandelRenderer) {
  var oThis = this;
  oThis.sDescription = 'Escape time';
...
BasicMandelTask.prototype.run = function () {
  var oThis = this;
...
BasicMandelTask.prototype.setPixel = function() {
  var oThis = this,
      iIterations = 0,
      nCI = oThis.nY,
  ...
  var nProgressToInfinity = 1 - (iIterations - .5) / oThis.oMandelRenderer.iMaxIterations;
