...
function UITab(oUITabs, oNextObject) {
  ...
  addEvents(oThis, ['selected', 'removed',
      'changeSize', 'changeBorderColor', 'changeBorderStyle', 'changeBorderWidth', 'changeBorderRadius',
      'changeBackgroundColor', ]);
  oUITabs.__oTabUIBox = new UIBox(oThis.__doNodes.oTabsNode, '100%', '100%');
  oUITabs.__oBodyUIBox = new UIBox(oThis.__doNodes.oBody, '100%', '100%');
}
addEventsCode(UITab);
...
oPrototype.select = function () {                           this.oUITabs.selectTab(this);
                                                            return this; }
oPrototype.getTitleElement = function() {                   return this.__oTabUIBox.getInnerElement(); }
oPrototype.getBodyElement = function() {                    return this.__oBodyUIBox.getInnerElement(); }
